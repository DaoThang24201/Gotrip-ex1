                                ...
                                <div class="col-auto">
                                    <div class="blogCard__image rounded-4">
                                        <div class="ratio ratio-1:1 w-250">
                                            <img src="img/blog/list-2/1.png" alt="image" class="img-ratio rounded-4">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <a href="blog-single.html" class="blogCard -type-1 col-12">
                            <div class="row y-gap-15 items-center md:justify-center md:text-center">
                                <div class="col-auto">
                                    <div class="blogCard__image rounded-4">
                                        <div class="ratio ratio-1:1 w-250">
                                            <img src="img/blog/list-2/2.png" alt="image" class="img-ratio rounded-4">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md">
                                    ...
                                    <h3 class="text-22 text-dark-1 mt-10 md:mt-5">
                                        The top 7 places in Japan to see cherry blossom
                                    </h3>
                        ...
                        <a href="blog-single.html" class="blogCard -type-1 col-12">
                            <div class="row y-gap-15 items-center md:justify-center md:text-center">
                                <div class="col-auto">
                                    <div class="blogCard__image rounded-4">
                                        <div class="ratio ratio-1:1 w-250">
                                            <img src="img/blog/list-2/3.png" alt="image" class="img-ratio rounded-4">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md">
                                    ...
                                    <h3 class="text-22 text-dark-1 mt-10 md:mt-5">
                                        Baby’s first trip, from glamping to luxury resorts
                                    </h3>
                        ...
                        <a href="blog-single.html" class="blogCard -type-1 col-12">
                            <div class="row y-gap-15 items-center md:justify-center md:text-center">
                                <div class="col-auto">
                                    <div class="blogCard__image rounded-4">
                                        <div class="ratio ratio-1:1 w-250">
                                            <img src="img/blog/list-2/4.png" alt="image" class="img-ratio rounded-4">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <a href="blog-single.html" class="blogCard -type-1 col-12">
                            <div class="row y-gap-15 items-center md:justify-center md:text-center">
                                <div class="col-auto">
                                    <div class="blogCard__image rounded-4">
                                        <div class="ratio ratio-1:1 w-250">
                                            <img src="img/blog/list-2/5.png" alt="image" class="img-ratio rounded-4">
                                        </div>
                                    </div>
                                </div>
